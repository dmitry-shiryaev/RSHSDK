 ...
 * 
 * \file LA-n10-12PCI_StartStop.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in "Start-Stop" mode for LA-n10-12PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в режиме "Старт-Стоп" для устройства ЛА-н10-12PCI
 * 
 */
...
const char* BoardName = "LAN10_12PCI" ;
