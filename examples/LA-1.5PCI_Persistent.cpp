 ...
 * 
 * \file LA-1.5PCI_Persistent.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in continuous mode for LA-1.5PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в непрерывном режиме для устройства ЛА-1.5PCI
 * 
 */
...
const double SampleFreq = 250000.0;
...
const U32 InternalBufferSize = 10240;
