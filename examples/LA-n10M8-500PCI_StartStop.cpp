 ...
 * 
 * \file LA-n10M8-500PCI_StartStop.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in "Start-Stop" mode for LA-n10M8-500PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в режиме "Старт-Стоп" для устройства ЛА-н10M8-500PCI
 * 
 */
...
const char* BoardName = "LAN10M8_500PCI" ;
...
int main()
{
	...
	RSH_BUFFER_S8 userBuffer( p.bufferSize * activeChanNumber);
