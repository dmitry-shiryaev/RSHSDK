 ...
 * 
 * \file GSPF-053USB_Generate.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Analog signal generation example for GSPF-053USB device
 * 
 * \~russian
 * \brief
 * Пример генерации аналогового сигнала для устройства ГСПФ-053USB
 * 
 */
...
const char* BoardName = "GSPF053USB" ;
