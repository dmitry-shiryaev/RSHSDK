 ...
 * 
 * \file LA-i24USB_Persistent.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in continuous mode for LA-i24USB device
 * 
 * \~russian
 * \brief
 * Сбор данных в непрерывном режиме для устройства ЛА-и24USB
 * 
 */
...
const U32 InternalBufferSize = 256;
