 ...
 * 
 * \file LA-20USB_Persistent.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in continuous mode for LA-20USB device
 * 
 * \~russian
 * \brief
 * Сбор данных в непрерывном режиме для устройства ЛА-20USB
 * 
 */
...
const double SampleFreq = 25000.0;
...
const U32 InternalBufferSize = 5120;
