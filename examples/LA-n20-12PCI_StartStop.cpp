 ...
 * 
 * \file LA-n20-12PCI_StartStop.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in "Start-Stop" mode for LA-n20-12PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в режиме "Старт-Стоп" для устройства ЛА-н20-12PCI
 * 
 */
...
const char* BoardName = "LAN20_12PCI" ;
...
const double SampleFreq = 50.0e+6;
