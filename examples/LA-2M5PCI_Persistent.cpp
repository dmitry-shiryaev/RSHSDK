 ...
 * 
 * \file LA-2M5PCI_Persistent.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in continuous mode for LA-2M5PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в непрерывном режиме для устройства ЛА-2М5PCI
 * 
 */
...
const double SampleFreq = 200000.0;
