 ...
 * 
 * \file LA-50USB_Persistent.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in continuous mode for LA-50USB device
 * 
 * \~russian
 * \brief
 * Сбор данных в непрерывном режиме для устройства ЛА-50USB
 * 
 */
...
const double SampleFreq = 10000.0;
...
const U32 InternalBufferSize = 2048;
