 ...
 * 
 * \file LA-n10M8-100PCI_StartStop.cpp
 * \date 28.12.2015
 * 
 * \~english
 * \brief
 * Data acquisition in "Start-Stop" mode for LA-n10M8-100PCI device
 * 
 * \~russian
 * \brief
 * Сбор данных в режиме "Старт-Стоп" для устройства ЛА-н10M8-100PCI
 * 
 */
...
const double SampleFreq = 1.0e+8;
